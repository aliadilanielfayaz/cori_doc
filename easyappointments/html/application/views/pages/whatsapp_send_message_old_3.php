        ...
        <div id="calendar-filter" class="col-md-3">
            <div class="calendar-filter-items">
                <select id="select-filter-item"
                        ...
                        aria-label="Filter">
                    <option value="all"><?= lang('filter_all') ?></option>
                    <optgroup label="<?= lang('filter_executant') ?>">
                        <option value="executant_1"><?= lang('executant_1') ?></option>
                        <option value="executant_2"><?= lang('executant_2') ?></option>
                        <option value="executant_3"><?= lang('executant_3') ?></option>
                    </optgroup>
                    <optgroup label="<?= lang('filter_prestation') ?>">
                        <option value="prestation_1"><?= lang('prestation_1') ?></option>
                        <option value="prestation_2"><?= lang('prestation_2') ?></option>
                        <option value="prestation_3"><?= lang('prestation_3') ?></option>
                    </optgroup>
                </select>
            </div>
        </div>
